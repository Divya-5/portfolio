...
const projectData = [
  ...
  },
  {
    ...
    description:
      "Created a new site for Teethtoday south Africa region according to latest design  similar to the US version. Developed the whole site according to the latest design and content availability.",
