...
const EmailSection = () => {
  return (
    <section className=" py-8 sm:py-16">
      <h2 class="text-center text-4xl font-bold text-white py-2">
        Contact Section
      </h2>
      <div className="grid md:grid-cols-2 gap-4 relative" id="contact">
        <div>
          ...
          <p className="text-[#ADB7BE] mb-4 max-w-md">
            ...
            open. Whether you have a question or you wanted to say hi, I will
