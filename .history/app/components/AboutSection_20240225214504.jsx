...
const TAB_DATA = [
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>AEM Bussiness Practitioner</li>
...
const AboutSection = () => {
  ...
  return (
    <section className="text-white" id="a">
      <div className="md:grid md:grid-cols-2  items-center py-8  sm:py-16 ">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col  h-full ">
          ...
          <p className="text-base lg:text-lg">
            ...
            working with JavaScript, React, Next, SASS, LESS, HTML, CSS, and
