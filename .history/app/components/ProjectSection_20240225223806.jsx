...
const projectData = [
  ...
  },
  {
    ...
    description:
      " Authored the whole MIHM site from scratch by doing the code level changes according to the latest design from Figma. Perform code review and manage technical debtHandle release deployments and production issues on stage and dev instance 
